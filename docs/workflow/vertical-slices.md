...
| VS-28 | Order Detail command screen | Tabbed Overview · Work · Money + pushed More Details; stage-aware primary action — decomposed into [28.1–28.4](./vs-28-order-detail/00-overview.md) | Post-MVP — **In progress** |
