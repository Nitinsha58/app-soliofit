...
| VS-29 | Order WhatsApp messaging | Send-status WhatsApp message from Order Detail + dashboard cards + post-create modal (predefined templates + payment line); track sent-per-status — decomposed into [29.1–29.4](./vs-29-whatsapp/00-overview.md) | Post-MVP — **Done** |
