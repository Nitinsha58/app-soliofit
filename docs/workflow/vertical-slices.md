...
| VS-29 | Order WhatsApp messaging | Send-status WhatsApp message from Order Detail (predefined templates + payment line); track sent-per-status, restyle button — decomposed into [29.1–29.2](./vs-29-whatsapp/00-overview.md) | Post-MVP — **Pending** |
