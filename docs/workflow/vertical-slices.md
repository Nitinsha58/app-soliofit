...
| VS-29 | Order WhatsApp messaging | Send-status WhatsApp message from Order Detail + dashboard cards + post-create modal; finalized warm template set + working-hours pickup window — decomposed into [29.1–29.8](./vs-29-whatsapp/00-overview.md) | Post-MVP — **29.1–29.4 Done; 29.5–29.8 Pending** |
